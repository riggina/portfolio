...
export default function About() {
  return (
    <div className='' id='aboutme' >
        <svg className="h-24 w-full rotate-180" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        ...
        <div className='bg-slate-50 py-24 mt-0'>
            <div className='max-w-6xl relative flex mx-auto gap-12'>
