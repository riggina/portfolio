      ...
      <div className='bg-white/10 py-9 flex flex-row'>
        ...
        <div className='p-3 max-w-lg mx-auto'>
          <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
              <div>
                  <input onChange={(e) => setName(e.target.value)} value={name} type="name" placeholder='Write your name' className='font-poppins border-none p-3 rounded-lg bg-white/20 mix-blend-luminosity mr-3' required/>
